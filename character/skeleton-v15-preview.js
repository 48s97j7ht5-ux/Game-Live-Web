...
import {createSkeletonMechanicsV20} from './skeleton-mechanics-v20.js?v=20260813-geometry1';
...
const mod=await import('./skeleton-v15.js?v=20260813-geometry1');
THREE.Scene.prototype.add=originalSceneAdd;

const scene=capturedScene,api=mod.skeletonAPI;
if(!scene||!api)throw new Error('Skeleton v1.5 preview: API missing');
