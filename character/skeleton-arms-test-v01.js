...
import { createSkeletonMechanicsV1 } from './skeleton-mechanics-contract-v01.js?v=20260812-1742';
...
const mod=await import('./skeleton-v13.js?v=20260812-1738');
...
function apply(){const v=read();mechanics.reset();const out=mechanics.setArmPose('L',v);syncDebug();show(out);const m=api.getRestMetrics();status.textContent=`OK · native arms · upper ${(m.segments.upperarm_L*1000).toFixed(0)} mm · fore ${(m.segments.forearm_L*1000).toFixed(0)} mm`;}
