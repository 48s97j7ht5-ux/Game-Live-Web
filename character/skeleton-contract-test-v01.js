...
function syncDebug(){
 const h=mechanics.getJointWorld('hip_L'),k=mechanics.getJointWorld('knee_L'),a=mechanics.getJointWorld('ankle_L');
 markers.hip_L.position.copy(h);markers.knee_L.position.copy(k);markers.ankle_L.position.copy(a);placeLink(thigh,h,k);placeLink(shin,k,a);
}
